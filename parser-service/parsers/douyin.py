...
class DouyinParser:
    ...
    def get_video_info(self) -> Optional[dict]:
        ...
        return {
            ...
            'authorAvatar': (author.get('avatar_thumb') or {}).get('url_list', [''])[0] if author.get('avatar_thumb') else '',
    ...
    def _get_video_streams(self, video_data: dict) -> list:
        ...
        for br in bit_rate_list:
            ...
            estimated_size = (bit_rate_val / 8) * (duration_ms / 1000) if bit_rate_val and duration_ms else 0
    ...
    def _get_music_info(self, music: dict) -> Optional[dict]:
        ...
        cover = music.get('cover_large') or music.get('cover_medium') or music.get('cover_thumb') or {}
