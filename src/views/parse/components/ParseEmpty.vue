  ...
  <div class="empty-state">
    <div class="empty-content">
      <svg class="cat-icon" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg">
        <!-- 猫眼睛 -->
        <path class="cat-eye cat-eye-left"
              d="M405.47 362.54m-22.53 0a22.53 22.53 0 1 0 45.06 0 22.53 22.53 0 1 0-45.06 0Z" fill="currentColor"/>
        <path class="cat-eye cat-eye-right"
              d="M560.47 362.54m-22.53 0a22.53 22.53 0 1 0 45.06 0 22.53 22.53 0 1 0-45.06 0Z" fill="currentColor"/>
        <!-- 猫身体 -->
        <path
...
.cat-eye {
  opacity: 0;
  animation: fade-in var(--animation-draw-circle, 800ms) var(--easing-ease-out, ease-out) forwards;
}
