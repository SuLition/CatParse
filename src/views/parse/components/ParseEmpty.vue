      ...
      >
        <svg class="cat-icon" height="200" viewBox="0 0 1024 1024" width="200" xmlns="http://www.w3.org/2000/svg">
          ...
          <Motion
              ...
              :transition="{ duration: 0.3, delay: animationDuration * 0.3, ease: 'easeOut' }"
              as="circle"
              class="cat-eye"
              cx="405.47"
              cy="362.54"
          ...
          <Motion
              :animate="{ opacity: 1, scale: 1 }"
              :initial="{ opacity: 0, scale: 0 }"
              :transition="{ duration: 0.3, delay: animationDuration * 0.4, ease: 'easeOut' }"
              as="circle"
              class="cat-eye"
              cx="560.47"
              cy="362.54"
